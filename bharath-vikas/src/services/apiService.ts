...
class ApiService {
  ...
  async fetchEconomicData(): Promise<ApiResponse<EconomicIndicator[]>> {
    try {
  ...
  async fetchSocialData(): Promise<ApiResponse<SocialIndicator[]>> {
    try {
      const mockData: SocialIndicator[] = [
        {
          id: 'literacy_rate',
          name: 'Literacy Rate',
          value: 77.7,
  ...
  async fetchEnvironmentalData(): Promise<ApiResponse<EnvironmentalIndicator[]>> {
    try {
      const mockData: EnvironmentalIndicator[] = [
        {
          id: 'aqi_delhi',
  ...
  async fetchHealthData(): Promise<ApiResponse<HealthIndicator[]>> {
    try {
      const mockData: HealthIndicator[] = [
        {
  ...
  async fetchGovernanceData(): Promise<ApiResponse<any[]>> {
    try {
      const mockData = [
        {
